...
public class ConstructionProject extends Project{
    private String constructionSite;
    private String contractor;

    public ConstructionProject(String projectID, String projectName, String description, String startDate, String endDate, double budget, ArrayList<Scheduler> schedulers, String constructionSite, String contractor) {
    ...
    public String toString(){
        ...
        // correctly formatted string to be used to save and read constrcution projects
